...
class ReplayProtectionService: ReplayProtector {
    ...
    private let logger = Logger(
        subsystem: "com.mehmetakifacar.Whisper", category: "ReplayProtection")
        ...
        return await withCheckedContinuation { continuation in
            ...
            context.perform {
                do {
                    ...
                    let fetchRequest: NSFetchRequest<ReplayProtectionEntity> =
                        ReplayProtectionEntity.fetchRequest()
                    ...
                    let countRequest: NSFetchRequest<ReplayProtectionEntity> =
                        ReplayProtectionEntity.fetchRequest()
    ...
    private func performCleanup(in context: NSManagedObjectContext, targetCount: Int? = nil) throws
    {
        ...
        let expiredFetchRequest: NSFetchRequest<NSFetchRequestResult> =
            ReplayProtectionEntity.fetchRequest()
        ...
        if let targetCount = targetCount {
            ...
            if currentCount > targetCount {
                ...
                let oldestFetchRequest: NSFetchRequest<NSFetchRequestResult> =
                    ReplayProtectionEntity.fetchRequest()
                oldestFetchRequest.sortDescriptors = [
                    NSSortDescriptor(key: "receivedAt", ascending: true)
                ]
